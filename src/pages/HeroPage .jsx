    ...
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
          <img className="object-cover object-center rounded" alt="hero" src="Images/pp.avif" />
        </div>
...
<p className="mb-8 leading-relaxed">
  Welcome to Job Finder, your ultimate destination to explore and apply for top job opportunities. Start your journey to a fulfilling career today!
</p>
          ...
          <div className="flex lg:flex-row md:flex-col">
            ...
            <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center lg:ml-4 md:ml-0 ml-4 md:mt-4 mt-0 lg:mt-0 hover:bg-gray-200 focus:outline-none">
              ...
              <span className="ml-4 flex items-start flex-col leading-none">
                <span className="text-xs text-gray-600 mb-1">AVAILABLE ON</span>
