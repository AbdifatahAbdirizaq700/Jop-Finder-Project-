      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2">
            <li><a href="/about" className="text-sm hover:text-primary-500">About</a></li>
            <li><a href="/jobs" className="text-sm hover:text-primary-500">Find Jobs</a></li>
            <li><a href="/employers" className="text-sm hover:text-primary-500">Employers</a></li>
            <li><a href="/contact" className="text-sm hover:text-primary-500">Contact Us</a></li>
            <li><a href="/privacy-policy" className="text-sm hover:text-primary-500">Privacy Policy</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-sm">123 JobFinder Ave, Career City, CO 12345</p>
          <p className="text-sm">Email: support@jobfinder.com</p>
          <p className="text-sm">Phone: (123) 456-7890</p>
  
          <div className="mt-4">
            <h3 className="text-lg font-semibold">Follow Us</h3>
            <div className="flex space-x-4 mt-2">
              <a href="https://www.facebook.com" target="_blank" className="text-white hover:text-primary-500">
              ...
              <a href="https://www.twitter.com" target="_blank" className="text-white hover:text-primary-500">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com" target="_blank" className="text-white hover:text-primary-500">
                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
